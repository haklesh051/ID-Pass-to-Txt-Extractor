...
token_cp ='eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..vJ08JMti0aaUkUu5luqc7uA-trgmmGwlRCYAj7FKFZDQt8Mewe01_XaqmWACmF48'
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/mr_x5_bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+3k-1zcJxINYwNGZl"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/mr_x5_bot")],
    ]
)
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://i.postimg.cc/d0SScN1S/file-00000000bfe0622fa819cd4905b46476.png",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/mr_x5_bot")],
        ])
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://i.postimg.cc/d0SScN1S/file-00000000bfe0622fa819cd4905b46476.png",
        caption=caption
      ),
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/cCLB8hhb/file-00000000df0c622fac07b8a7a580db2a.png",
      caption=caption
    ),
    reply_markup=keyboard
    )
